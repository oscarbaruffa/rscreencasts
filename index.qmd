...
<iframe class="video" src="https://www.youtube.com/embed/{vid_key}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

## Timestamps

<script id="timestamps" type="application-json">{ jsonlite::toJSON(topic_timestamps) }</script>
'
)
