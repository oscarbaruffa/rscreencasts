...
embed_pix_w_small <- embed_pix_w * 1
embed_pix_h_small <- embed_pix_h * 1
...
The recordings were done as part of a weekly R programming challenge called TidyTuesday. Below you'll find a list of `r screencasts_count`  timestamped screencasts.
...
## Full screencast
<iframe width="',embed_pix_w,'" height="',embed_pix_h,'" src="https://www.youtube.com/embed/', as.character(screencasts_data[entry_screencast, "vid_key"]),'" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<iframe width="',embed_pix_w_small,'" height="',embed_pix_h_small,'" src="https://www.youtube.com/embed/', as.character(screencasts_data[entry_screencast, "vid_key"]),'?start=',as.character(timestamps_entries[entry_timestamp, "timestamp_sec"]),'" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>\n')
