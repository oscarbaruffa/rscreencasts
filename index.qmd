...
for (entry in row.names(screencasts_data)) {
   ...
   topic <- as.character(screencasts_data[entry, "screencast"])
...
## Timestamp
<iframe width="',embed_pix_w_small,'" height="',embed_pix_h_small,'" src="https://www.youtube.com/embed/', as.character(screencasts_data[entry, "vid_key"]),'?start=106" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>')
